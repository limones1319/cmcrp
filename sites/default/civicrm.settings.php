...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://compucorp:Sun9Jul,21:48@localhost/db_drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://compucorp_civi:mon10jul0107@localhost/db_civicrm?new_link=true');
}
...
$civicrm_root = '/var/www/compucorp/html/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/compucorp/html/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://compucorp.neimportant.ro/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '36022bd4a5d9630ce639c6d743da5891');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/compucorp/html/sites/default/files/civicrm/templates_c//mail.log');
// }
